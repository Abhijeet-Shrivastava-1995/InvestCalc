  ...
  <div class="c-wrap">
    <div class="c-header">
      ...
      <div class="detail">
        ...
        <div class="date">{{active.month}}</div>
      </div>
    ...
    <div class="c-body">
      <div class="c-body-week">
        <div class="c-body-week-label" v-for=" w in weekList" v-bind:key="w.weekList">{{w}}</div>
      </div>
      <div class="c-body-day">
        <div class="c-body-row" v-for="week in weeks" v-bind:key="week.weeks"> 
          <div class="c-body-date"
               ...
               v-for="d in week" v-bind:key="d.week"
               @click="dateClicked"
               :data-year="d.year"
               :data-month="d.month"
               :data-date="d.date"
...
//
        var _date = new Date(_year, _month - 2)
        var from = {
      ...
      nextMonth: function () {
        ...
        var _month = this.active.month
//        下月日期对象
        var ndate = new Date(_year, _month)
        var from = {
          year: this.active.year,
          month: this.active.month
        }
...
//        console.log('first day',firstDay)
        ...
        for (i = 1; i <= new Date(this.active.year, this.active.month, 0).getDate(); i++) {
